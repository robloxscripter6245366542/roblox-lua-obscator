...
--==============================================================================
-- EZ HUB — RIVALS features (built on the Acrylic library above)
--==============================================================================
...
-- UI
-- ==============================================================================
local combatSec = Window:CreateSection("Combat")
...
aimTab:CreateSlider({ Name = "Trigger Delay (ms)", Min = 0, Max = 500, Default = flags.trigDelay, Step = 10, Flag = "trigdelay", Callback = function(v) flags.trigDelay = v end })

local espTab = combatSec:CreateTab("Visuals")
espTab:CreateToggle({ Name = "ESP", Default = false, Flag = "esp", Callback = function(v) flags.esp = v end })
...
Window:Notify({ Title = "Ez Hub - RIVALS", Description = "Loaded. Press Right-Shift to toggle.", Duration = 4 })
