...
export const TOOL_DEFS: Anthropic.Tool[] = [
  {
    name: "bash",
    description:
      "Run a shell command in the working folder and return its combined stdout and stderr. " +
  ...
  {
    name: "read_file",
    description: "Read a UTF-8 text file. Path is relative to the working folder (or absolute).",
    input_schema: {
      type: "object",
  ...
  {
    name: "list_dir",
    description: "List the entries of a directory (relative to the working folder, or absolute).",
    input_schema: {
      type: "object",
      properties: { path: { type: "string" } },
      required: ["path"],
