...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:ji,depthTest:!1,depthWrite:!1})}function gm(){return new Zi({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:dh(),fragmentShader:`
		...
		`,blending:ji,depthTest:!1,depthWrite:!1})}function _m(){return new Zi({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:dh(),fragmentShader:`
